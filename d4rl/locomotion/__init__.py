...
register(
    ...
    kwargs={
        ...
        'reward_type':'sparse',
        'non_zero_reset':False,
        'dataset_url':'http://rail.eecs.berkeley.edu/datasets/offline_rl/ant_maze_new/Ant_maze_ultra_noisy_multistart_True_multigoal_True_sparse.hdf5',
        'eval':True,
        'maze_size_scaling': 4.0,
        'ref_min_score': 0.0,
        'ref_max_score': 1.0,
...
register(
    ...
    kwargs={
        ...
        'reward_type':'sparse',
        'non_zero_reset':False,
        'dataset_url':'http://rail.eecs.berkeley.edu/datasets/offline_rl/ant_maze_new/Ant_maze_ultra_noisy_multistart_True_multigoal_False_sparse.hdf5',
        'eval':True,
        'maze_size_scaling': 4.0,
        'ref_min_score': 0.0,
        'ref_max_score': 1.0,
