...
register(
    id='mini_kitchen_microwave_kettle_light_slider-v0',
    entry_point='d4rl.kitchen:KitchenMicrowaveKettleLightSliderV0',
    max_episode_steps=280,
    kwargs={
        'ref_min_score': 0.0,
        'ref_max_score': 4.0,
        #TODO: 'dataset_url':'gs://.../mini_kitchen_microwave_kettle_light_slider-v0.hdf5'
    }
)
...
register(
    ...
    kwargs={
        'ref_min_score': 0.0,
        'ref_max_score': 4.0,
        #TODO: 'dataset_url':'gs://.../kitchen_microwave_kettle_light_slider-v0.hdf5'
    }
)
...
register(
    id='kitchen_microwave_kettle_bottomburner_light-v0',
    entry_point='d4rl.kitchen:KitchenMicrowaveKettleBottomBurnerLightV0',
    max_episode_steps=280,
    kwargs={
        'ref_min_score': 0.0,
        'ref_max_score': 4.0,
        #TODO 'dataset_url':'gs://.../kitchen_microwave_kettle_bottomburner_light-v0.hdf5'
    }
)
